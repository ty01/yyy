  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (!this.singleDatePicker && this.autoUpdateInput) {
        	var val = this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format);
        	...
        	if(this.element.is("input")){
            	...
            	this.element.find("input").val(val).trigger('change');
            }
